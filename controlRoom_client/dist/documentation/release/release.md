...
| May 2026             | Documentation refresh        | Functional + technical docs; mass-change SME reference; UI illustrations; PDF export (`npm run pdf:html` or `pdf:all`) |
| May 2026             | Dynamic menu & profile       | `ICR_MENU_*`, `SET0000040/41`, header Change password (`53`, `54`) |
| May 2026             | Supply Chain AI              | Assistant, skill studio, data health, context learning (see functional/supply-chain-ai/) |

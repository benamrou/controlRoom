...
Inventory Control Room consists of an **Angular client**, **Node.js API server**, and **Oracle** application database (plus GOLD connectivity via DB links).

The following topics cover installation:

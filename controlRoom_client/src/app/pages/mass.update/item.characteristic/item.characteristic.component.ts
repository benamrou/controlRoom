...
@Component({
    selector: 'item-characteristic',
    templateUrl: './item.characteristic.component.html',
    styleUrls: ['./item.characteristic.component.scss', '../../../app.component.scss'],
    encapsulation: ViewEncapsulation.None
})

export class ItemCharacteristicComponent implements OnInit{
  ...
  private buildMassUpdateSteps(): void {
    this.menuItems = buildMassUpdateMenuItems(this._labels, this._labels.text('S25.MU.STP0', 'Select your Warehouse item description file change.'));
                        ...
                        () => { 
                                ...
                                if (rowsWithError.length === 0) {
                                    ...
                                    this.globalValid.push('<i class="fas fa-thumbs-up" style="padding-right: 1em;"></i> Data file verification SUCCESSFUL ' +
                                                            ...
                                                            ' <li>Item/LV codes are all recognized</li></ul>'); 

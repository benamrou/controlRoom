...
@Component({
    selector: 'variable-weight',
    templateUrl: './variable.weight.component.html',
    styleUrls: ['./variable.weight.component.scss', '../../../app.component.scss'],

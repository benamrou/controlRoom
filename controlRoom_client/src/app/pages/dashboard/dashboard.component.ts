...
import { WidgetService, Widget, ScreenService } from '../../shared/services/index';
...
@Component({
    ...
    providers: [WidgetService, MessageService, ScreenService],
...
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    constructor(public _widgetService: WidgetService, public _messageService: MessageService, private _screenInfo: ScreenService) {
        ...
        // Step 1 - Get list of widgets allowed for the user
        // To avoid always looking at data
        if (this._widgetService.widgetsInfo.widgets.length === 0 ) {
            try {

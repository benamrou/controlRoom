-- =============================================================================
-- 98_data_health_resolution_sql_bind_fix.sql
-- Fix inline resolution binds: accept bind name OR column header in JSON body;
-- validate binds on dry-run; fail when UPDATE/MERGE affects 0 rows.
-- Deploy after 52. Re-runnable (CREATE OR REPLACE only).
-- =============================================================================

...
* Log folders: logs/admin/{M.D.YYYY}/{username}.log (all services — alert, crontab, watchdog, users)
* Example:
*     logs/admin/5.19.2026/watchdog.log
*     logs/admin/5.19.2026/abe.log
*
...
function logFile(uniqueId, message, username) {
    const { dayDir } = buildLogStructure();

/**
* This is the description for Item Data API class. The initlaized request for CORS (different URL reuqest)
...
*
* API Library: /controller/warehouse/itemdata
*
...
* Http Method: GET
* URL        : /api/warehouse/itemdata/?PARAM=...
*
*
* @method get
...
module.get = function (request,response) {
        ...
        app.get('/api/warehouse/itemdata/1/', function (request, response) {
        "use strict";
        ...
        // Update picking unit 
        app.get('/api/warehouse/itemdata/2/', function (request, response) {
            "use strict";
            response.setHeader('Access-Control-Allow-Origin', '*');
            // requestuest methods you wish to allow
            response.setHeader('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS');

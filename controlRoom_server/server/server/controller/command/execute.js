...
module.get = function (request,response) {
        ...
        app.get('/api/execute/1/', function (request, response) {
            ...
            var ssh = new SSH({
                ...
                user: request.header('ENV_ID'),
                pass: request.header('ENV_PASS')
            });
            ssh.exec("echo '/home/hntcen/env/envCEN;psifa60p;'  |  sshpass -p Heinen123! ssh hntcen@10.200.14.232", {
            ...
            .ssh.execCommand("echo '/home/hntcen/env/envCEN;psifa60p;'  |  sshpass -p Heinen123! ssh hntcen@10.200.14.232")
            .ssh.dispose();*/
            
            /*var shell = require('shelljs');
            shell.exec("echo '/home/hntcen/env/envCEN;psifa60p;'  |  sshpass -p Heinen123! ssh hntcen@10.200.14.232",
           ...
           /* var host = {
                ...
                /*for (let i =0; i < this.sshObj._connections.length; i ++) {
                    this.sshObj._connections[i].end();
                }*/

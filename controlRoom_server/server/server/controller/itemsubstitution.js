/**
* This is the description for Item Substitution API class. The initlaized request for CORS (different URL reuqest)
...
*
* API Library: /controller/itemsubstitution
*
...
* Http Method: GET
* URL        : /api/itemsubstitution/?PARAM=...
*
*
* @method get
...
*
* sub-module calls LIBQUERY entry ART0000004
*/
module.get = function (request,response) {
        app.get('/api/itemsubstitution/', function (request, response) {
        "use strict";

/**
* This is the description for Supplier API class. The initlaized request for CORS (different URL reuqest)
...
*
* API Library: /controller/supplier
*
...
module.get = function (request,response) {
        app.get('/api/supplier/1/', function (request, response) {
        "use strict";

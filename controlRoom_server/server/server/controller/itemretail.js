/**
* This is the description for Item Retail API class. The initlaized request for CORS (different URL reuqest)
...
*
* sub-module calls LIBQUERY entry ART0000003
*/
module.get = function (request,response) {
        app.get('/api/itemretail/', function (request, response) {
        "use strict";
        ...
        app.get('/api/itemretail/1/', function (request, response) {
            "use strict";
            response.setHeader('Access-Control-Allow-Origin', '*');
            // requestuest methods you wish to allow
            response.setHeader('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS');

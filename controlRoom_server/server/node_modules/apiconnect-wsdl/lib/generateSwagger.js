...
function generateSwaggerForWsdlProxy(wsdlEntry, serviceName, wsdlId, options) {
    ...
    inOptions.type = 'wsdl';
    inOptions.wssecurity = (typeof inOptions.wssecurity === 'undefined') ? true : inOptions.wssecurity;
...
function getSwaggerForService(wsdlEntry, serviceName, wsdlId, inputFlags) {
    ...
    inputFlags.wssecurity = (typeof inputFlags.wssecurity === 'undefined') ? true : inputFlags.wssecurity;
...
function _getSwaggerForService(wsdlEntry, serviceName, wsdlId, inputFlags) {
    ...
    let genSOAPOptions = {
        ...
        wssecurity: inputFlags.wssecurity
    };

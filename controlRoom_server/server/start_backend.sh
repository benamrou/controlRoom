...
nohup forever start -o ./logs/server/out_batch.log -e ./logs/server/err_batch.log -c nodemon server_admin.js package.json 8091 --watch ./server server_admin.js --ignore ./repository/  ./alerts/ ./node_modules/ ./scripts/ ./uploads/ ./views/ ./documentation/ ./logs/ --exitcrash &
echo -e "[${GREEN}LAST${NC}]\t - ALERTS EXECUTION SERVER NODE: 8092..... \t[${GREEN}DONE${NC}]"
nohup forever start -o ./logs/alerts/out_crontab.log -e ./logs/alerts/err_crontab.log -c nodemon server_admin.js package.json 8092 CRONTAB --watch ./server server_admin.js --ignore ./repository/ ./alerts/ ./node_modules/ ./scripts/ ./uploads/ ./views/ ./documentation/ ./logs/ --exitcrash &
echo -e "[${GREEN}LAST${NC}]\t - SERVER NODE: 8090..... \t\t\t[${GREEN}DONE${NC}]"
nohup forever start -o ./logs/server/out_server.log -e ./logs/server/err_server.log -c nodemon server_admin.js package.json 8090 --watch ./server server_admin.js --ignore ./repository/  ./alerts/ ./node_modules/ ./scripts/ ./uploads/ ./views/ ./documentation/ ./logs/ --exitcrash &
